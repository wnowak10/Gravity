...
Table of contents:
- # [1.1 Categorical dependent variables](#catdeps)
	- # [1.1.1 Numeric features](#numfeatures)
	- # [1.1.2 Categorical features](#catfeatures)
- # [1.2 Numerical dependent variables](#numdeps)
