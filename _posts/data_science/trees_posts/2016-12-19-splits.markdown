...
We'll assume that this dependent variable is a binary random variable. And we'll also assume that our trees will only have two branches emanating from each node.
