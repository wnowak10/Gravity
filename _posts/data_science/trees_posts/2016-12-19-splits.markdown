...
This is the first part of a series where I intend to explain how decision trees work. In this, I will cover part 1 (How do vanilla tree algorithms even work?). Parts 2-4 will be in subsequent posts.

* Part 1: How do vanilla tree algorithms even work?
* Part 2: Why random forests are useful and what ensembles are
* Part 3: How gradient boosting applies
* Part 4: What bagging is
...
Also, be aware that for each new idea, I'll try to first explain it in my own words, using my own generated ideas. This might mean that I use notation that differs from best practice. But, I find that it can often help me to think through problems on my own first, before delving into the literature and reading about best practices. Of course, though, I will do this too. Part I of this post entails my walking though and example and thinking through a basic tree. [Part II](#part2) of this post entails my explaining the current literature on decision tree splitting algorithms. 

## Table of contents
- ### [- Part I -- My explanation of tree splitting](#part1)
- #### [Ia Categorical dependent variables](#catdeps)
- #### [Ib Numerical dependent variables](#numdeps)
...
<br>
{: id="part1"}
# Part I: Decision splitting, in my own words and thoughts.
<br>
...
Let's first investigate how these things work for predicting categorical dependent variables. We'll assume that this dependent variable is a binary random variable. And we'll also assume that our trees will only have two branches emanating from each node.
