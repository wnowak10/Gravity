...
* [1. How do vanilla tree algorithms even work](#algorithms)
	* [1.1 For categorical dependent variables](#categorical) 
	* [1.2 For numerical dependent variables](#numerical)
...
Let's first investigate how these things work for predicting categorical dependent variables We'll assume that this dep. var. is a binary random variable. And we'll also assume that our trees will only have two branches emanating from each node.
...
The situation is a bit simpler for dependent variables. 
...
This post is getting long. If you made it through this, move ahead to part 2 where I talk about forests and ensembles. 
