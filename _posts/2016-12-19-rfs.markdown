...
2. Assuming that decision trees are understood, I am going to address the questions above, while also talking about the process through which I do so. 
...
To sum up, Wikipedia gives some semi-helpful pseudo-code that explains the decision tree process (though the gorey and exciting details are absent).
...
But how does the computer actually do this? In particular, how do they determine that attribute "a" has the highest information gain?
...
1. Which of the p features is best to split on?
2. Where do we split this feature (if it is numeric or categorical with more than 2 outcomes)?
